...
display_names = {
    ...
    'binarytrees-submitted.dat' : 'Binary Trees (Submitted)',
    'chameneosredux.dat' : 'Chameneos Redux',
    'chameneosredux-fast.dat' : 'Chameneos Redux (Fast)',
    'fannkuch-redux-submitted.dat' : 'Fannkuch Redux',
    'fasta2.dat' : 'Fasta (2)',
    'fasta6.dat' : 'Fasta (6)',
    'fasta-submitted.dat' : 'Fasta (Submitted)',
    'knucleotide-hash.dat' : 'K-Nucleotide (Hash-Based)',
    'knucleotide-submitted.dat' : 'K-Nucleotide (Submitted)',
    'mandelbrot2.dat' : 'Mandelbrot (2)',
    'mandelbrot-submitted.dat' : 'Mandelbrot (Submitted)',
    'nbody3.dat' : 'N-Body (3)',
    'nbody4.dat' : 'N-Body (4)',
    'nbody-submitted.dat' : 'N-Body (Submitted)',
    'no-op.dat' : 'No-Op',
    ...
    'spectralnorm2-40000.dat' : 'Spectral Norm (Version 2, Size 40000)',
    'spectralnorm2.dat' : 'Spectral Norm (Version 2, Size 500)',
    'spectralnorm-submitted-40000.dat' : 'Spectral Norm (Version 1, Size 40000)',
    'spectralnorm-submitted.dat' : 'Spectral Norm (Version 1, size 500)',
...
def aggregate_runs(full_fname, method = 'mean'):
    if method == 'mean':
